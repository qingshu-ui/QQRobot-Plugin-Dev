...
class ReceivedOfflineFileEvent;
struct ReceivedOfflineFileEventDefaultTypeInternal;
extern ReceivedOfflineFileEventDefaultTypeInternal _ReceivedOfflineFileEvent_default_instance_;
}  // namespace cqhttp
PROTOBUF_NAMESPACE_OPEN
...
template<> ::cqhttp::ReceivedOfflineFileEvent* Arena::CreateMaybeMessage<::cqhttp::ReceivedOfflineFileEvent>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cqhttp {
...
class ReceivedOfflineFileEvent final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cqhttp.ReceivedOfflineFileEvent) */ {
 public:
  inline ReceivedOfflineFileEvent() : ReceivedOfflineFileEvent(nullptr) {}
  ~ReceivedOfflineFileEvent() override;
  explicit PROTOBUF_CONSTEXPR ReceivedOfflineFileEvent(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ReceivedOfflineFileEvent(const ReceivedOfflineFileEvent& from);
  ReceivedOfflineFileEvent(ReceivedOfflineFileEvent&& from) noexcept
    : ReceivedOfflineFileEvent() {
    *this = ::std::move(from);
  }

  inline ReceivedOfflineFileEvent& operator=(const ReceivedOfflineFileEvent& from) {
    CopyFrom(from);
    return *this;
  }
  inline ReceivedOfflineFileEvent& operator=(ReceivedOfflineFileEvent&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ReceivedOfflineFileEvent& default_instance() {
    return *internal_default_instance();
  }
  static inline const ReceivedOfflineFileEvent* internal_default_instance() {
    return reinterpret_cast<const ReceivedOfflineFileEvent*>(
               &_ReceivedOfflineFileEvent_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    13;

  friend void swap(ReceivedOfflineFileEvent& a, ReceivedOfflineFileEvent& b) {
    a.Swap(&b);
  }
  inline void Swap(ReceivedOfflineFileEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ReceivedOfflineFileEvent* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ReceivedOfflineFileEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ReceivedOfflineFileEvent>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ReceivedOfflineFileEvent& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ReceivedOfflineFileEvent& from) {
    ReceivedOfflineFileEvent::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ReceivedOfflineFileEvent* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "cqhttp.ReceivedOfflineFileEvent";
  }
  protected:
  explicit ReceivedOfflineFileEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:cqhttp.ReceivedOfflineFileEvent)
 private:
  class _Internal;
...
// int64 time = 1;
inline void ReceivedOfflineFileEvent::clear_time() {
  _impl_.time_ = int64_t{0};
}
inline int64_t ReceivedOfflineFileEvent::_internal_time() const {
  return _impl_.time_;
}
inline int64_t ReceivedOfflineFileEvent::time() const {
  // @@protoc_insertion_point(field_get:cqhttp.ReceivedOfflineFileEvent.time)
  return _internal_time();
}
inline void ReceivedOfflineFileEvent::_internal_set_time(int64_t value) {
  
  _impl_.time_ = value;
}
inline void ReceivedOfflineFileEvent::set_time(int64_t value) {
  _internal_set_time(value);
  // @@protoc_insertion_point(field_set:cqhttp.ReceivedOfflineFileEvent.time)
}

// int64 self_id = 2;
inline void ReceivedOfflineFileEvent::clear_self_id() {
  _impl_.self_id_ = int64_t{0};
}
inline int64_t ReceivedOfflineFileEvent::_internal_self_id() const {
  return _impl_.self_id_;
}
inline int64_t ReceivedOfflineFileEvent::self_id() const {
  // @@protoc_insertion_point(field_get:cqhttp.ReceivedOfflineFileEvent.self_id)
  return _internal_self_id();
}
inline void ReceivedOfflineFileEvent::_internal_set_self_id(int64_t value) {
  
  _impl_.self_id_ = value;
}
inline void ReceivedOfflineFileEvent::set_self_id(int64_t value) {
  _internal_set_self_id(value);
  // @@protoc_insertion_point(field_set:cqhttp.ReceivedOfflineFileEvent.self_id)
}

// .cqhttp.CQHTTP_TYPE post_type = 3;
inline void ReceivedOfflineFileEvent::clear_post_type() {
  _impl_.post_type_ = 0;
}
inline ::cqhttp::CQHTTP_TYPE ReceivedOfflineFileEvent::_internal_post_type() const {
  return static_cast< ::cqhttp::CQHTTP_TYPE >(_impl_.post_type_);
}
inline ::cqhttp::CQHTTP_TYPE ReceivedOfflineFileEvent::post_type() const {
  // @@protoc_insertion_point(field_get:cqhttp.ReceivedOfflineFileEvent.post_type)
  return _internal_post_type();
}
inline void ReceivedOfflineFileEvent::_internal_set_post_type(::cqhttp::CQHTTP_TYPE value) {
  
  _impl_.post_type_ = value;
}
inline void ReceivedOfflineFileEvent::set_post_type(::cqhttp::CQHTTP_TYPE value) {
  _internal_set_post_type(value);
  // @@protoc_insertion_point(field_set:cqhttp.ReceivedOfflineFileEvent.post_type)
}

// .cqhttp.CQHTTP_TYPE notice_type = 4;
inline void ReceivedOfflineFileEvent::clear_notice_type() {
  _impl_.notice_type_ = 0;
}
inline ::cqhttp::CQHTTP_TYPE ReceivedOfflineFileEvent::_internal_notice_type() const {
  return static_cast< ::cqhttp::CQHTTP_TYPE >(_impl_.notice_type_);
}
inline ::cqhttp::CQHTTP_TYPE ReceivedOfflineFileEvent::notice_type() const {
  // @@protoc_insertion_point(field_get:cqhttp.ReceivedOfflineFileEvent.notice_type)
  return _internal_notice_type();
}
inline void ReceivedOfflineFileEvent::_internal_set_notice_type(::cqhttp::CQHTTP_TYPE value) {
  
  _impl_.notice_type_ = value;
}
inline void ReceivedOfflineFileEvent::set_notice_type(::cqhttp::CQHTTP_TYPE value) {
  _internal_set_notice_type(value);
  // @@protoc_insertion_point(field_set:cqhttp.ReceivedOfflineFileEvent.notice_type)
}

// int64 user_id = 5;
inline void ReceivedOfflineFileEvent::clear_user_id() {
  _impl_.user_id_ = int64_t{0};
}
inline int64_t ReceivedOfflineFileEvent::_internal_user_id() const {
  return _impl_.user_id_;
}
inline int64_t ReceivedOfflineFileEvent::user_id() const {
  // @@protoc_insertion_point(field_get:cqhttp.ReceivedOfflineFileEvent.user_id)
  return _internal_user_id();
}
inline void ReceivedOfflineFileEvent::_internal_set_user_id(int64_t value) {
  
  _impl_.user_id_ = value;
}
inline void ReceivedOfflineFileEvent::set_user_id(int64_t value) {
  _internal_set_user_id(value);
  // @@protoc_insertion_point(field_set:cqhttp.ReceivedOfflineFileEvent.user_id)
}

// .cqhttp.OfflineFile file = 6;
inline bool ReceivedOfflineFileEvent::_internal_has_file() const {
  return this != internal_default_instance() && _impl_.file_ != nullptr;
}
inline bool ReceivedOfflineFileEvent::has_file() const {
  return _internal_has_file();
}
inline const ::cqhttp::OfflineFile& ReceivedOfflineFileEvent::_internal_file() const {
...
inline const ::cqhttp::OfflineFile& ReceivedOfflineFileEvent::file() const {
  // @@protoc_insertion_point(field_get:cqhttp.ReceivedOfflineFileEvent.file)
  return _internal_file();
}
inline void ReceivedOfflineFileEvent::unsafe_arena_set_allocated_file(
    ::cqhttp::OfflineFile* file) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.file_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cqhttp.ReceivedOfflineFileEvent.file)
}
inline ::cqhttp::OfflineFile* ReceivedOfflineFileEvent::release_file() {
...
inline ::cqhttp::OfflineFile* ReceivedOfflineFileEvent::unsafe_arena_release_file() {
  // @@protoc_insertion_point(field_release:cqhttp.ReceivedOfflineFileEvent.file)
  
  ::cqhttp::OfflineFile* temp = _impl_.file_;
  _impl_.file_ = nullptr;
  return temp;
}
inline ::cqhttp::OfflineFile* ReceivedOfflineFileEvent::_internal_mutable_file() {
...
inline ::cqhttp::OfflineFile* ReceivedOfflineFileEvent::mutable_file() {
  ::cqhttp::OfflineFile* _msg = _internal_mutable_file();
  // @@protoc_insertion_point(field_mutable:cqhttp.ReceivedOfflineFileEvent.file)
  return _msg;
}
inline void ReceivedOfflineFileEvent::set_allocated_file(::cqhttp::OfflineFile* file) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.file_);
  }
  ...
  _impl_.file_ = file;
  // @@protoc_insertion_point(field_set_allocated:cqhttp.ReceivedOfflineFileEvent.file)
}
