...
PROTOBUF_CONSTEXPR ReceivedOfflineFileEvent::ReceivedOfflineFileEvent(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.file_)*/nullptr
  , /*decltype(_impl_.time_)*/int64_t{0}
  , /*decltype(_impl_.self_id_)*/int64_t{0}
...
struct ReceivedOfflineFileEventDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ReceivedOfflineFileEventDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ReceivedOfflineFileEventDefaultTypeInternal() {}
  union {
    ReceivedOfflineFileEvent _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ReceivedOfflineFileEventDefaultTypeInternal _ReceivedOfflineFileEvent_default_instance_;
...
const uint32_t TableStruct_cqhttp_5fevent_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::cqhttp::ReceivedOfflineFileEvent, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::cqhttp::ReceivedOfflineFileEvent, _impl_.time_),
  PROTOBUF_FIELD_OFFSET(::cqhttp::ReceivedOfflineFileEvent, _impl_.self_id_),
  PROTOBUF_FIELD_OFFSET(::cqhttp::ReceivedOfflineFileEvent, _impl_.post_type_),
  PROTOBUF_FIELD_OFFSET(::cqhttp::ReceivedOfflineFileEvent, _impl_.notice_type_),
  PROTOBUF_FIELD_OFFSET(::cqhttp::ReceivedOfflineFileEvent, _impl_.user_id_),
  PROTOBUF_FIELD_OFFSET(::cqhttp::ReceivedOfflineFileEvent, _impl_.file_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 185, -1, -1, sizeof(::cqhttp::ReceivedOfflineFileEvent)},
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::cqhttp::_ReceivedOfflineFileEvent_default_instance_._instance,
...
const char descriptor_table_protodef_cqhttp_5fevent_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\t\"\277\001\n\030ReceivedOfflineFileEvent\022\014\n\004tim"
...
class ReceivedOfflineFileEvent::_Internal {
 public:
  static const ::cqhttp::OfflineFile& file(const ReceivedOfflineFileEvent* msg);
};

const ::cqhttp::OfflineFile&
ReceivedOfflineFileEvent::_Internal::file(const ReceivedOfflineFileEvent* msg) {
  return *msg->_impl_.file_;
}
void ReceivedOfflineFileEvent::clear_file() {
  if (GetArenaForAllocation() == nullptr && _impl_.file_ != nullptr) {
    delete _impl_.file_;
  }
  _impl_.file_ = nullptr;
}
ReceivedOfflineFileEvent::ReceivedOfflineFileEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:cqhttp.ReceivedOfflineFileEvent)
}
ReceivedOfflineFileEvent::ReceivedOfflineFileEvent(const ReceivedOfflineFileEvent& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ReceivedOfflineFileEvent* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.file_){nullptr}
    , decltype(_impl_.time_){}
    , decltype(_impl_.self_id_){}
  ...
  ::memcpy(&_impl_.time_, &from._impl_.time_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.user_id_) -
    reinterpret_cast<char*>(&_impl_.time_)) + sizeof(_impl_.user_id_));
  // @@protoc_insertion_point(copy_constructor:cqhttp.ReceivedOfflineFileEvent)
}

inline void ReceivedOfflineFileEvent::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
ReceivedOfflineFileEvent::~ReceivedOfflineFileEvent() {
  // @@protoc_insertion_point(destructor:cqhttp.ReceivedOfflineFileEvent)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void ReceivedOfflineFileEvent::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.file_;
}

void ReceivedOfflineFileEvent::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void ReceivedOfflineFileEvent::Clear() {
// @@protoc_insertion_point(message_clear_start:cqhttp.ReceivedOfflineFileEvent)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ReceivedOfflineFileEvent::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* ReceivedOfflineFileEvent::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:cqhttp.ReceivedOfflineFileEvent)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cqhttp.ReceivedOfflineFileEvent)
  return target;
}

size_t ReceivedOfflineFileEvent::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:cqhttp.ReceivedOfflineFileEvent)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ReceivedOfflineFileEvent::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ReceivedOfflineFileEvent::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ReceivedOfflineFileEvent::GetClassData() const { return &_class_data_; }


void ReceivedOfflineFileEvent::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ReceivedOfflineFileEvent*>(&to_msg);
  auto& from = static_cast<const ReceivedOfflineFileEvent&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:cqhttp.ReceivedOfflineFileEvent)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void ReceivedOfflineFileEvent::CopyFrom(const ReceivedOfflineFileEvent& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:cqhttp.ReceivedOfflineFileEvent)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ReceivedOfflineFileEvent::IsInitialized() const {
  return true;
}

void ReceivedOfflineFileEvent::InternalSwap(ReceivedOfflineFileEvent* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ReceivedOfflineFileEvent, _impl_.user_id_)
      + sizeof(ReceivedOfflineFileEvent::_impl_.user_id_)
      - PROTOBUF_FIELD_OFFSET(ReceivedOfflineFileEvent, _impl_.file_)>(
          reinterpret_cast<char*>(&_impl_.file_),
          reinterpret_cast<char*>(&other->_impl_.file_));
}

::PROTOBUF_NAMESPACE_ID::Metadata ReceivedOfflineFileEvent::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_cqhttp_5fevent_2eproto_getter, &descriptor_table_cqhttp_5fevent_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::cqhttp::ReceivedOfflineFileEvent*
Arena::CreateMaybeMessage< ::cqhttp::ReceivedOfflineFileEvent >(Arena* arena) {
  return Arena::CreateMessageInternal< ::cqhttp::ReceivedOfflineFileEvent >(arena);
}
